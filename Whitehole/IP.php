 ...
 padding-top: 1px; padding-bottom: 1px">
				...
				<div align="center">
					<ul>
					    ...
					    <!-- <li class="s"><a href="IP.php"><font style="font-size:20px"> IP <font>
		...
		//////////////////////////////////////////////////////
			...
			echo'&nbsp;&nbsp;&nbsp;&nbsp;
			<ul>
			<li> <font style="font-size: 12pt">  On  <u>IP</u> This page you can see ip, date and time. </font> </li>
			</ul>';
			}?>
			</div>  
...
echo '<meta http-equiv="refresh" content="0; url=IP.php">';
}
...
if ($pn == 1) {
    ...
    $centerPages .= '&nbsp; <a href="' . $_SERVER['IP.php'] . '?pn=' . $add1 . '">  <button type="button" class="btn btn-success">' . $add1 . '</button></a> &nbsp;';
	
	
} else if ($pn == $lastPage) {
    $centerPages .= '&nbsp; <a href="' . $_SERVER['IP.php'] . '?pn=' . $sub1 . '">  <button type="button" class="btn btn-success">' . $sub1 . '</button></a> &nbsp;';

    $centerPages .= '&nbsp; <span class="pagNumActive">' . $pn . '</span> &nbsp;';
	echo $centerPages;
} else if ($pn > 2 && $pn < ($lastPage - 1)) {
    $centerPages .= '&nbsp; <a href="' . $_SERVER['IP.php'] . '?pn=' . $sub2 . '"><button type="button" class="btn btn-success">' . $sub2 . '</button></a> &nbsp;';
    ...
    $centerPages .= '&nbsp; <a href="' . $_SERVER['IP.php'] . '?pn=' . $add2 . '"><button type="button" class="btn btn-success">' . $add2 . '</button></a> &nbsp;';
	echo $centerPages;
...
$sql2 = mysql_query("SELECT * FROM IP ORDER BY IP ASC $limit"); 
...
if ($lastPage != "1"){
    ...
    if ($pn != 1) {////echo "<a href='Manageusers.php?page=".($page-1)."' class='btn btn-danger'>Previous</a>";
        $previous = $pn - 1;
        $paginationDisplay .=  '&nbsp;  <a href="' . $_SERVER['IP.php'] . '?pn=' . $previous . '"> <button type="button" class="btn btn-danger"> Back </button></a> ';
    ...
    if ($pn != $lastPage) {
        $nextPage = $pn + 1;
        $paginationDisplay .=  '&nbsp;  <a href="' . $_SERVER['IP.php'] . '?pn=' . $nextPage . '"> <button type="button" class="btn btn-danger">Next</button></a> ';
		echo $paginationDisplay;
    }
}
///////////////////////////////////// END Pagination Display Setup ///////////////////////////////////////////////////////////////////////////
// Build the Output Section Here
$outputList = 'SELECT * FROM IP';#
$rowg[0]="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;IP&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
...
if (!isset($_SESSION["lghj"]) && $_SESSION["fg"]=="1" || $_SESSION["lghj"]!="IP" && $_SESSION["fg"]=="1"){
echo '<div align="center"><form method="POST" action="Gallery2.php">
<input type="submit" name="Delete_" value="Delete"></input>
</form></div><br>';

   	if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['Delete_'])) 
	{
	$_SESSION["lghj"]="IP";
	echo '<meta http-equiv="refresh" content="0; url=IP.php">';
}
...
if($_SESSION["lghj"]=="IP" && $_SESSION["fg"]=="1")
{
